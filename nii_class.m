classdef nii_class
    %NII_CLASS Summary of this class goes here
    ...
    methods
        function dwi = nii_class(dcm2niixd_folder,varargin)
        ...
        end %okay, that's the whole constructor
    ...
    I'm worried this is going to use d2n2s.m as a method so 
    excuberantDonkeyMerich*7)&)*Y(*^(^)(*+_+_)(+_*)(*^*&%%#%@#%()(&++_*+
end
