function [new_source,M]=coregister_obj_animal(target_object_seg,source_obj_seg)
% this is the same function as coregister_obj, but the relevant reg
% parameters are scaled by 10
